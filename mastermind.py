...
def create_code():
    """Function that creates the 4 digit code, using random digits \
        from 1 to 8"""
...
def get_answer_input():
    ...
    while len(answer) != 4 or answer.isdigit() != True \
        or '9' in answer or '0' in answer:
...
def run_game():
    ...
    show_instructions()
    turns = 0
    while correct == False and turns < 12:
